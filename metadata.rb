...
source_url 'https://github.com/akkinenivijay/cassandra-chef-cookbook' if respond_to?(:source_url)
issues_url 'https://github.com/akkinenivijay/cassandra-chef-cookbook/issues' if respond_to?(:issues_url)
version '4.5.0'
depends 'java'
depends 'ulimit'
depends 'apt'
